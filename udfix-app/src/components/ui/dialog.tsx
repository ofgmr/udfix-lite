...
const DialogContent = React.forwardRef<
  ...
  DialogContentProps
>(({ className, children, variant = "glass", animated = true, hover = "none", glass, style, overlayClassName, ...props }, ref) => {
  const glassStyle = getGlassStyles(glass);
  ...
  const variantClass = React.useMemo(() => {
    switch (variant) {
      ...
      case "glassSubtle": return "glass-panel";
